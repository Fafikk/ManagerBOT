    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: 'Uptime', value: `<t:${Math.floor(Date.now() / 1000 - botUptime)}:R>`, inline: false },
                { name: 'Ilość serwerów', value: serverCount.toString(), inline: false },
                { name: 'Ilość użytkowników', value: memberCount.toString(), inline: false },
                { name: 'Użycie pamięci RAM', value: `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} MB`, inline: false },
